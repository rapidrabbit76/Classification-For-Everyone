...
class MobileNetV1Model(pl.LightningModule):
...
def train():
    ...
    wandb_logger.watch(mobilenetv1, log='all', log_freq=100)
    ...
    # Train
    trainer.fit(mobilenetv1, datamodule=dm)
    trainer.test(mobilenetv1, datamodule=dm)

    # Finish
    wandb_logger.experiment.unwatch(mobilenetv1)
